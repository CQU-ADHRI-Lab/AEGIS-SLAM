...
Odometry::Odometry()
    ...
    config_.arbitration_enable = declare_parameter<bool>("arbitration_enable", config_.arbitration_enable);
    config_.arbitration_alpha = declare_parameter<double>("arbitration_alpha", config_.arbitration_alpha);
    config_.arbitration_geo_sigma = declare_parameter<double>("arbitration_geo_sigma", config_.arbitration_geo_sigma);
    config_.arbitration_anchor_voxel_size = declare_parameter<double>("arbitration_anchor_voxel_size", config_.arbitration_anchor_voxel_size);
    config_.arbitration_anchor_k = declare_parameter<int>("arbitration_anchor_k", config_.arbitration_anchor_k);
    config_.arbitration_min_correspondence_count = declare_parameter<int>(
        "arbitration_min_correspondence_count", config_.arbitration_min_correspondence_count);
    config_.arbitration_dynamic_geo_reject_threshold = declare_parameter<double>(
        "arbitration_dynamic_geo_reject_threshold", config_.arbitration_dynamic_geo_reject_threshold);
    config_.arbitration_dynamic_residual_reject_threshold = declare_parameter<double>(
        "arbitration_dynamic_residual_reject_threshold", config_.arbitration_dynamic_residual_reject_threshold);
    config_.arbitration_dynamic_hard_reject = declare_parameter<bool>(
        "arbitration_dynamic_hard_reject", config_.arbitration_dynamic_hard_reject);
    config_.arbitration_debug_print_every_n = declare_parameter<int>(
        "arbitration_debug_print_every_n", config_.arbitration_debug_print_every_n);
    config_.arbitration_debug_print_weight_changed_points = declare_parameter<bool>(
        "arbitration_debug_print_weight_changed_points",
        config_.arbitration_debug_print_weight_changed_points);
    config_.arbitration_debug_weight_change_eps = declare_parameter<double>(
        "arbitration_debug_weight_change_eps", config_.arbitration_debug_weight_change_eps);
    config_.arbitration_debug_print_anchor_points = declare_parameter<bool>(
        "arbitration_debug_print_anchor_points",
        config_.arbitration_debug_print_anchor_points);
    config_.arbitration_debug_max_anchor_points = declare_parameter<int>(
        "arbitration_debug_max_anchor_points", config_.arbitration_debug_max_anchor_points);
