...
Odometry::Odometry(const ros::NodeHandle &nh, const ros::NodeHandle &pnh)
    ...
    pnh_.param("arbitration_enable", config_.arbitration_enable, config_.arbitration_enable);
    pnh_.param("arbitration_warmup_iterations", config_.arbitration_warmup_iterations, config_.arbitration_warmup_iterations);
    pnh_.param("arbitration_alpha", config_.arbitration_alpha, config_.arbitration_alpha);
    pnh_.param("arbitration_dynamic_alpha", config_.arbitration_dynamic_alpha, config_.arbitration_dynamic_alpha);
    pnh_.param("arbitration_geo_sigma", config_.arbitration_geo_sigma, config_.arbitration_geo_sigma);
    pnh_.param("arbitration_anchor_voxel_size", config_.arbitration_anchor_voxel_size, config_.arbitration_anchor_voxel_size);
    pnh_.param("arbitration_anchor_residual_max", config_.arbitration_anchor_residual_max, config_.arbitration_anchor_residual_max);
    pnh_.param("arbitration_anchor_k", config_.arbitration_anchor_k, config_.arbitration_anchor_k);
    pnh_.param("arbitration_min_anchor_count", config_.arbitration_min_anchor_count, config_.arbitration_min_anchor_count);
    pnh_.param("arbitration_min_correspondence_count", config_.arbitration_min_correspondence_count, config_.arbitration_min_correspondence_count);
    pnh_.param("arbitration_geo_score_floor", config_.arbitration_geo_score_floor, config_.arbitration_geo_score_floor);
    pnh_.param("arbitration_dynamic_geo_score_floor", config_.arbitration_dynamic_geo_score_floor, config_.arbitration_dynamic_geo_score_floor);
    pnh_.param("arbitration_dynamic_geo_reject_threshold", config_.arbitration_dynamic_geo_reject_threshold, config_.arbitration_dynamic_geo_reject_threshold);
    pnh_.param("arbitration_dynamic_residual_reject_threshold", config_.arbitration_dynamic_residual_reject_threshold, config_.arbitration_dynamic_residual_reject_threshold);
    pnh_.param("arbitration_dynamic_hard_reject", config_.arbitration_dynamic_hard_reject, config_.arbitration_dynamic_hard_reject);
    pnh_.param("arbitration_debug_print_every_n", config_.arbitration_debug_print_every_n, config_.arbitration_debug_print_every_n);
    pnh_.param("arbitration_debug_print_weight_changed_points",
               config_.arbitration_debug_print_weight_changed_points,
               config_.arbitration_debug_print_weight_changed_points);
    pnh_.param("arbitration_debug_weight_change_eps",
               config_.arbitration_debug_weight_change_eps,
               config_.arbitration_debug_weight_change_eps);
    pnh_.param("arbitration_debug_print_anchor_points",
               config_.arbitration_debug_print_anchor_points,
               config_.arbitration_debug_print_anchor_points);
    pnh_.param("arbitration_debug_max_anchor_points",
