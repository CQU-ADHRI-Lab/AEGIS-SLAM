...
class Basic_config():
    def __init__(self):
        ...
        self.arbitration_enable: bool = True
        self.arbitration_alpha: float = 0.5
        self.arbitration_geo_sigma: float = 0.5
        self.arbitration_anchor_voxel_size: float = 0.6
        self.arbitration_anchor_k: int = 4
        self.arbitration_min_correspondence_count: int = 300
        self.arbitration_dynamic_geo_reject_threshold: float = 0.25
        self.arbitration_dynamic_residual_reject_threshold: float = 0.8
        self.arbitration_dynamic_hard_reject: bool = True
        self.arbitration_debug_print_every_n: int = 1
        self.arbitration_debug_print_weight_changed_points: bool = True
        self.arbitration_debug_weight_change_eps: float = 0.05
        self.arbitration_debug_print_anchor_points: bool = True
        self.arbitration_debug_max_anchor_points: int = 200
        ...
        parameters=[
            {
                ...
                "arbitration_enable": config.arbitration_enable,
                "arbitration_alpha": config.arbitration_alpha,
                "arbitration_geo_sigma": config.arbitration_geo_sigma,
                "arbitration_anchor_voxel_size": config.arbitration_anchor_voxel_size,
                "arbitration_anchor_k": config.arbitration_anchor_k,
                "arbitration_min_correspondence_count": config.arbitration_min_correspondence_count,
                "arbitration_dynamic_geo_reject_threshold": config.arbitration_dynamic_geo_reject_threshold,
                "arbitration_dynamic_residual_reject_threshold": config.arbitration_dynamic_residual_reject_threshold,
                "arbitration_dynamic_hard_reject": config.arbitration_dynamic_hard_reject,
                "arbitration_debug_print_every_n": config.arbitration_debug_print_every_n,
                "arbitration_debug_print_weight_changed_points": config.arbitration_debug_print_weight_changed_points,
                "arbitration_debug_weight_change_eps": config.arbitration_debug_weight_change_eps,
                "arbitration_debug_print_anchor_points": config.arbitration_debug_print_anchor_points,
                "arbitration_debug_max_anchor_points": config.arbitration_debug_max_anchor_points,
